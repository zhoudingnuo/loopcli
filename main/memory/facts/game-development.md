...
- **成语闯关开发启动**（Task #26）：W1核心MVP已派发给frontend agent
  - 目标：20关可玩Demo + 1000条成语DB + 出题引擎 + 答题界面 + 连击系统
  - 技术栈：TTML+TTSS+原生JS，复用三消框架(storage/ad-manager/social)
- **下一步**：成语闯关W1完成 → W2社交+完整体验 → 三消提审材料补充
